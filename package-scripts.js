...
module.exports = {
    scripts: {
        ...
        copy: {
            default: {
                script: `nps copy.swagger && nps copy.public && nps copy.dotenv`
            },
            dotenv: {
                script: copyOne('.env', './dist')
            },
            swagger: {
        ...
        db: {
            migrate: {
                default: {
                    script: series('\"./node_modules/.bin/knex\" migrate:latest')
                },
                rollback: series('\"./node_modules/.bin/knex\" migrate:rollback')
            },
            seed: {
                script: series('\"./node_modules/.bin/knex\" seed:run')
            },
            reset: {
                script: series('nps console db:reset')
            }
        },
        /**
